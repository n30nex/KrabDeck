...
|-- test_chat_conversation_view/ Chat conversation view binding and selection behavior
...
|-- test_debug_policy/           Release/debug logging policy and secret redaction gates
...
|-- test_gps_track_log/          GPS track log record/trim and map breadcrumb policy
...
|-- test_mesh_dashboard/         Mesh health dashboard stats and refresh contracts
...
|-- test_ota_runtime_policy/     OTA runtime session and abort policy
|-- test_ota_write/              Exact-write, partial-I/O, overflow, and abort policy
|-- test_packet_validation/      Mesh packet shape and payload floor validation
...
|-- test_telemetry_lpp/          Telemetry LPP encode/decode bounds
...
|-- test_terminal_vars/          Terminal variable get/set and bounds
